...
public enum Feature {
	...
	FLOATING_POINT,
	BW_GRAPHICS, COLOR_GRAPHICS, DYNSIZE_GRAPHICS,
	NEW_DYNSIZE_GRAPHICS,
	NATIVE_KEYBOARD, PARAVIRTUAL_KEYBOARD,
	WILDCARD_PCLINK,
	NATIVE_DISK, PARAVIRTUAL_DISK,
	PARAVIRTUAL_CLIPBOARD,
	SPI, SERIAL, SPI_NETWORK,
	...
	public static final EnumSet<Feature> ALL = EnumSet.of(FLOATING_POINT,
			...
			NEW_DYNSIZE_GRAPHICS,
			NATIVE_KEYBOARD, PARAVIRTUAL_KEYBOARD,
			WILDCARD_PCLINK,NATIVE_DISK, PARAVIRTUAL_DISK,
			PARAVIRTUAL_CLIPBOARD, SPI, SERIAL, SPI_NETWORK,
			POWER_MANAGEMENT, LARGE_ADDRESS_SPACE);

	public static final EnumSet<Feature> NATIVE = EnumSet.of(FLOATING_POINT,
			BW_GRAPHICS, NATIVE_KEYBOARD, NATIVE_DISK, SPI, SERIAL, SPI_NETWORK,
			LARGE_ADDRESS_SPACE);

	public static final EnumSet<Feature> JS = EnumSet.of(BW_GRAPHICS,
			DYNSIZE_GRAPHICS, PARAVIRTUAL_KEYBOARD, PARAVIRTUAL_DISK,
			PARAVIRTUAL_CLIPBOARD, POWER_MANAGEMENT);

	public static final EnumSet<Feature> C = EnumSet.of(FLOATING_POINT, BW_GRAPHICS,
			NEW_DYNSIZE_GRAPHICS, NATIVE_KEYBOARD, NATIVE_DISK, PARAVIRTUAL_CLIPBOARD, SPI, SERIAL);
