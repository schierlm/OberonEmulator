...
public enum Feature {
	...
	DYNAMIC_RESOLUTION, SEAMLESS_RESIZE,
	NATIVE_KEYBOARD, PARAVIRTUAL_KEYBOARD,
	WILDCARD_PCLINK,
	NATIVE_DISK, PARAVIRTUAL_DISK,
	PARAVIRTUAL_CLIPBOARD, HOST_FILESYSTEM,
	SPI, SERIAL, MULTI_SERIAL, SPI_NETWORK, PARAVIRTUAL_WIZNET, PARAVIRTUAL_HOST_TRANSFER,
	...
	public static final EnumSet<Feature> ALL = EnumSet.of(FLOATING_POINT,
			...
			PARAVIRTUAL_HOST_TRANSFER, POWER_MANAGEMENT, LARGE_ADDRESS_SPACE);
	...
	public static final EnumSet<Feature> C = EnumSet.of(FLOATING_POINT, BW_GRAPHICS,
			DYNSIZE_GRAPHICS, NATIVE_KEYBOARD, NATIVE_DISK, PARAVIRTUAL_CLIPBOARD,
